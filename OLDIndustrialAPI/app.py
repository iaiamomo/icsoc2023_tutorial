...
if mode == 'plan':
    from OLDIndustrialAPI.actors_api_plan.server import server
elif mode == "mdp":
    from OLDIndustrialAPI.actors_api_mdp.server import server
elif mode == "mdp_ltlf":
    from OLDIndustrialAPI.actors_api_mdp_ltlf.server import server
else:
