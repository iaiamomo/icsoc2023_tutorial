...
from OLDIndustrialAPI.utils.target_simulator import TargetSimulator
from OLDIndustrialAPI.actors_api_mdp.client_wrapper import WebSocketWrapper
from OLDIndustrialAPI.actors_api_mdp.data import TargetInstance
from OLDIndustrialAPI.actors_api_mdp.helpers import setup_logger
from OLDIndustrialAPI.actors_api_mdp.messages import RegisterTarget, Message, RequestTargetAction, \
...
def main(spec, host, port):
    """Start target."""
    target_device = TargetDevice.from_spec(Path(spec), host="localhost", port=8765)
