...
from OLDIndustrialAPI.utils.declare_utils import *
from OLDIndustrialAPI.utils.dfa_target import from_symbolic_automaton_to_declare_automaton, mdp_from_dfa
from OLDIndustrialAPI.utils.utils import render_mdp_dfa


config_json = json.load(open('config.json', 'r'))
mode = config_json['mode']
print(mode)
if mode == "mdp_ltlf" or mode == "mdp":
    mymode = "mdp"
else:
    mymode = "plan"
