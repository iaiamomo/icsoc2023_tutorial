        ...
        for prop_name, prop in self.additional_properties.items():
            ...
            for componentsschemasreward_and_prob_distribution_item_data in prop:
                ...
                if isinstance(componentsschemasreward_and_prob_distribution_item_data, ProbDistribution):
                    componentsschemasreward_and_prob_distribution_item = componentsschemasreward_and_prob_distribution_item_data.to_dict()

                else:
                    componentsschemasreward_and_prob_distribution_item = componentsschemasreward_and_prob_distribution_item_data
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            ...
            for componentsschemasreward_and_prob_distribution_item_data in (_additional_property):
                def _parse_componentsschemasreward_and_prob_distribution_item(data: object) -> Union['ProbDistribution', float]:
                    try:
                ...
                componentsschemasreward_and_prob_distribution_item = _parse_componentsschemasreward_and_prob_distribution_item(componentsschemasreward_and_prob_distribution_item_data)
