...
from local.IndustrialAPI.actors_api_mdp_ltlf.data import ServiceInstance, TargetInstance, ServiceId
...
async def main(host: str, port: int) -> None:
    ...
    # target file
    dfa_target = target_dfa(Path(f"IndustrialAPI/actors_api_{mode}/descriptions_phase1/target_phase1.tdl"))
