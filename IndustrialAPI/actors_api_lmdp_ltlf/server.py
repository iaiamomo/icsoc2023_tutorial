...
from IndustrialAPI.actors_api_lmdp_ltlf.data import ServiceInstance, target_to_json, TargetInstance
from IndustrialAPI.actors_api_lmdp_ltlf.helpers import ServiceId, TargetId, setup_logger
from IndustrialAPI.actors_api_lmdp_ltlf.messages import from_json, Message, Register, Update, RegisterTarget, RequestTargetAction, \
...
class Server:
    ...
    def run(self, port: int = 8080) -> None:
        from IndustrialAPI.actors_api_lmdp_ltlf.app import app
