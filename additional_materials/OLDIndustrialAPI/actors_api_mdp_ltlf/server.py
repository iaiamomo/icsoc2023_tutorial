...
from OLDIndustrialAPI.actors_api_mdp_ltlf.client_wrapper import WebSocketWrapper
from OLDIndustrialAPI.actors_api_mdp_ltlf.data import ServiceInstance, target_to_json, TargetInstance
from OLDIndustrialAPI.actors_api_mdp_ltlf.helpers import ServiceId, TargetId, setup_logger
from OLDIndustrialAPI.actors_api_mdp_ltlf.messages import from_json, Message, Register, Update, RegisterTarget, RequestTargetAction, \
...
class Server:
    ...
    def run(self, port: int = 8080) -> None:
        from local.IndustrialAPI.app import app
